# Implement ranged and combat-consumable proof branches
...
relevant tests and docs/compat/05-options-147.md plus unique
evidence/options-147/. Read AGENTS.md/execution.md once. No runtime/client/
...
Exact cases (and no others): auto_fighter_range, rock_crab_range, green_dragon_special, green_dragon_potions.
