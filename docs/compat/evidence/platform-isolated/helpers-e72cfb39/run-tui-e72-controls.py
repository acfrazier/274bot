...
expected = (pathlib.Path('/Users/acfrazier/experiments/274bot/.worktrees/rs2b0t-multirevision/.superpowers/platform-preparation/platform-isolated-e72cfb39') if mac else
...
assert build['host_commit'] == 'e72cfb39ef086a89313961be8ca54d1d555e01f4'
...
binary = root / 'bin/platform_proof-e72cfb39'
