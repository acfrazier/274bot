...
impl CoreCase {
    ...
    pub fn card_name(self) -> &'static str {
        match self {
            ...
            Self::RangingGuildRound | Self::RangingGuildRedeem | Self::RangingGuildBank => {
                "RangingGuild"
            }
        }
    }
