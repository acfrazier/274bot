...
EXPORT = SRC / ".superpowers/review-exports/special-controls-t_68de6f48"
HOST = "2e6f02e728ff915a74ed339a5ebf3bd57fd5d6ee"
OVERLAY = [
    "tools/game-data/generate.ts",
    "tools/game-data/generate.test.ts",
    "tools/game-data/verify.ts",
    "crates/api/data/game-data/274.json",
    "crates/api/data/game-data/289.json",
    "crates/api/data/game-data/manifest.json",
    "crates/api/src/game_data.rs",
    "crates/api/tests/game_data.rs",
    "crates/script/src/special.rs",
    "crates/script/src/lib.rs",
    "crates/script/src/load.rs",
    "crates/script/src/shim/special.js",
    "crates/script/src/shim/mod.rs",
    "crates/script/tests/special.rs",
    "crates/host-play/src/lib.rs",
    "docs/compat/04-capabilities-special.md",
    "docs/compat/evidence/special-capabilities/README.md",
    "docs/compat/evidence/generated-game-data/verification.json",
]
