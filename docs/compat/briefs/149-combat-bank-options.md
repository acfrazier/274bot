# Implement remaining combat banking and return proofs
...
relevant tests and docs/compat/05-options-149.md plus unique
evidence/options-149/. Read AGENTS.md/execution.md once. No runtime/client/
...
Exact cases (and no others): auto_fighter_bank, moss_giant_bank, hill_giant_bank, chaos_druid_bank, ardy_fighter_bank.
