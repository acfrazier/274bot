...
for mode,name,args,prefix in jobs:
 ...
 (folder/(('binary-headless-' if mode=='headless' else 'binary-tui-' if mode=='tui' else 'binary-')+short+'.json')).write_text(json.dumps(receipt,indent=2)+'\n');print(json.dumps(receipt),flush=True)
