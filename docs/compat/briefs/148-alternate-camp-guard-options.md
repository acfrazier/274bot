# Implement alternate druid camps and Fight guard-response proofs
...
relevant tests and docs/compat/05-options-148.md plus unique
evidence/options-148/. Read AGENTS.md/execution.md once. No runtime/client/
...
Exact cases (and no others): chaos_druid_tower, chaos_druid_yanille, ardy_cakes_fight, ardy_thiever_fight.
