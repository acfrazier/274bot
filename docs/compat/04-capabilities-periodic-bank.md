...
`crates/script/src/load.rs` is a shared isolate register/lifecycle file. This task only added `__rs2b0t_periodic_bank` and Pause/Resume/ResetSession/hold clock hooks.

## Verification

Isolated target: `target-t_51452e47`. Raw logs: `docs/compat/evidence/periodic-bank-capabilities/`.
