...
def main(argv=None):
    ...
    env = os.environ.copy()
    for k in ['BOT_CPU','BOT_LIVE','BOT_DEBUG','MallocStackLogging','MallocStackLoggingNoCompact','BOT_MEMORY_SUSTAIN','BOT_MEMORY_SINGLE_RENDERER','BOT_MEMORY_RENDER_POLICY','BOT_NAV_CAPTURES','BOT_SCHEDULING_PROFILE','BOT_RENDER_PROFILE','BOT_GPU_COMPLETION_PROFILE']:
        env.pop(k, None)
