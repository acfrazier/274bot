...
$contractCellId = $CellId + '-long-contractcheck'
...
$env:TILE_BOXED_LONG_CONTRACT_ID = $contractId
$env:TILE_BOXED_LONG_BUILD_ROLE = $BuildRole
$env:TILE_BOXED_LONG_MODE = $Mode
$env:TILE_BOXED_LONG_CELL_ID = $contractCellId
$env:TILE_BOXED_LONG_TARGET_CELL_ID = $CellId
$env:TILE_BOXED_LONG_PREFLIGHT_CELL_ID = $CellId
...
$receipt = Join-Path ([Environment]::GetFolderPath('UserProfile')) ('274bot-runs\tile-boxed-long-contract-'+$contractId+'.json')
