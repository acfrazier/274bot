...
pub(crate) use combat::{
    ...
    green_dragon_tele_scenario, hill_giant_bank_scenario, hill_giant_loot_deposit_scenario,
    hill_giant_scenario, moss_giant_bank_scenario, moss_giant_bank_start_scenario,
    moss_giant_scenario, rock_crab_bank_scenario, rock_crab_range_scenario, rock_crab_scenario,
};
