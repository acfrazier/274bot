...
rmc.main = no_launch
os.environ["TILE_BOXED_BUILD_ROLE"] = "baseline"
os.environ["TILE_BOXED_MODE"] = "focused-plus-background"
os.environ["TILE_BOXED_CELL_ID"] = "baseline-focused-plus-background-contract-fixture"
os.environ["TILE_BOXED_HOST_ROOT"] = str(root)
runner = pathlib.Path(r"C:/ProgramData/274bot-Test/renderer-owner-census-9268890/run-tile-boxed-focused-one.py")
try:
