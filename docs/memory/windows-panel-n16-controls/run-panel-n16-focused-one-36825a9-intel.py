...
diag = ["panel", "16", "active", "--binary", str(binary), "--build-manifest", str(manifest), "--build-role", "candidate", "--sustain", "--diagnostics", "--warmup", "30", "--observe", "120", mode_flag, "--render-profile", "--gpu-completion-profile", "--scheduling-profile", "--responsiveness-profile", "--responsiveness-fine", "--failure-capture"]
if MODE == "focused-one":
