...
EXPORT = SRC / ".superpowers/review-exports/inventory-t_c0a5785e"
OVERLAY = [
    "crates/script/src/shim/client_adapter.js",
    "crates/script/tests/client_adapter_inventory.rs",
]
...
def main() -> int:
    ...
    if client_dest.exists():
        # gitlink placeholder may have been skipped (not a blob)
        pass
