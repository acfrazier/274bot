...
manifest = json.loads((root/'docs/compat/evidence/catalog-headed/source-paint025.json').read_text())
build = json.loads((root/'docs/compat/evidence/catalog-headed/binary-tui-paint025.json').read_text())
job = build
...
out=root/'docs/compat/evidence/paint-input-ui-025'/('tui'+revision+'-'+label)
