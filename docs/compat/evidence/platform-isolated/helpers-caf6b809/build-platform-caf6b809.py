...
assert not win, 'This bounded follow-up is Linux TUI only'
jobs=[('platform_proof',['build','-p','tui','--example','platform_proof','--features','memory-profile','--message-format=json'])]
