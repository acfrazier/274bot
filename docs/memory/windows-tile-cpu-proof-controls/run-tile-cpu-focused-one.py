...
ROLES = {
    "baseline": {"stage": pathlib.Path(r"C:\ProgramData\274bot-Test\renderer-owner-census-9268890"), "manifest_role": "reference", "manifest_side": "control", "binary_sha256": "e2deb1db371366f674c18e39d04f7309480310072ade224ffa1433c84d4559b5", "host_commit": "9268890217d968cfeb7c66ebb11dd5c3dd2c084f", "host_sources_sha256": "84054d9c02394d959cd84681dd85f3589d3a559b94bb37856c6f87cb0629269a", "host_sources_file_count": 871, "client_commit": "abb811bd0afa1acd99319ccd5bc36bfb241080f9", "client_sources_sha256": "ea6402702a56dc29359bf4effd9ca87407734fc9d940bfabdefb92cec8bf41ee", "client_sources_file_count": 183},
    "candidate": {"stage": pathlib.Path(r"C:\ProgramData\274bot-Test\tile-boxed-fb3589a"), "manifest_role": "candidate", "manifest_side": "candidate", "binary_sha256": "a9b581bab780d2868035941d799d416f0ef9ec68d5eb5a4fe0a62fa29670667f", "host_commit": "fb3589ac28583242b999ac864ea69c4ef8fa5923", "host_sources_sha256": "189dac149beb6f258f5a79bdf09de43818556a5f06ffa783a608f0113a64d8a4", "host_sources_file_count": 876, "client_commit": "fd956c91bf09e059359c8e182a33583e2c626cd3", "client_sources_sha256": "fad2e79248c8d62cff2ceba5c757ef555705e85d3dc6797586c9841d9dbfb53e", "client_sources_file_count": 183},
}
...
side = {"commit": role_info["host_commit"], "sources_sha256": role_info["host_sources_sha256"], "source_file_count": role_info["host_sources_file_count"], "client": {"commit": role_info["client_commit"], "sources_sha256": role_info["client_sources_sha256"], "source_file_count": role_info["client_sources_file_count"]}}
dump(manifest, {role_info["manifest_side"]: side, "features": {"requested": "memory-profile-no-alloc", "allocation_counting": False, "allocator": "std::alloc::System"}, "binaries": {role_info["manifest_side"] + "_panel_play": {"path": str(binary), "sha256": sha(binary)}}, "performance_acceptance": False, "functional_only": True})
...
fixture = {"world": "configured native active fixture", "loadout": "trade_bot catalog entry"}
dump(conditions, {"purpose": "Native N1 CPU-fallback functional proof", "role": role, "mode": mode, "cell_id": cell_id, "fixture": fixture, "backend": "cpu_fallback", "requested_backend": "cpu_fallback", "cpu_renderer_cadence": "configured/default", "performance_acceptance": False, "native_preflight": preflight_record, "checked_server": preflight_record["server"], "owner_census": False, "debug": False, "stack_logging": False, "counting": False})
...
spec = {"id": "native-panel-tile-cpu-" + cell_id, "index": 1, "cell_id": cell_id, "build_role": role_info["manifest_role"], "mode": mode, "kind": "functional", "frontend": "panel", "count": 1, "fixture": fixture, "requested_backend": "cpu_fallback", "cpu_fallback": True, "binary": str(binary), "build_manifest": str(manifest), "server_identity_path": str(server_id), "host_conditions_path": str(conditions), "launcher_argv": [sys.executable, str(mem / "run_diagnostic.py"), *diag], "diagnostic_argv": diag, "game_server_pid": pid, "ambient_helpers": {"bootstrap": os.getppid()}, "sampler_interval_s": 0.5, "max_wall_s": 900, "observe_s": 120, "warmup_s": 30, "teardown_grace_s": 60, "process_backend": "system", "performance_acceptance": False, "functional_only": True}
sp = out / "spec.json"
dump(sp, spec)
