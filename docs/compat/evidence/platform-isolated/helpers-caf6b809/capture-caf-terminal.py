...
root = (base / '.superpowers/platform-preparation/platform-isolated-caf6b809' if surface == 'mac' else
...
dest = base / 'docs/compat/evidence/platform-isolated' / (surface + '-tui-caf6b809') / ('r' + revision + '-' + run_label) / 'controls'
