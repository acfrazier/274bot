...
jobs=[('host-tests-rest',['cargo','test','--workspace','--features','memory-profile','--no-fail-fast','--','--skip','bright_catalog_cards_start_without_not_impl','--skip','declared_abi_fixture_matches_local_dts'],root),('client-tests',['cargo','test','-p','client','--tests','--features','audio'],root/'vendor/fr-client-rust')]
rows=[]
